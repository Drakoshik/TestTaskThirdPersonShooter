...
namespace TPS.Engine.Features.Player.PlayerMovement.PlayerVisualStateMachine.Aiming.States
{
    ...
    internal sealed class ReloadState : IBaseVisualAimingState, IState.IWithEnterAction
    {
        public Animator Animator { get; }
        public PlayerAnimationData PlayerAnimationData { get; }

        public ReloadState(Animator animator, PlayerAnimationData playerAnimationData)
        {
            Animator = animator;
        ...
        {
            Animator.SetTrigger(PlayerAnimationData.ReloadParameterHash);
